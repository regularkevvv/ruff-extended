...
pub fn search_paths<'db>(
    ...
    SearchPathIterator {
        ...
        // Plugin stub overlays only shadow modules for typing, never at runtime.
        plugin_stub_overlays: resolve_mode
            .is_typing()
            .then(|| search_paths.plugin_stub_overlays.iter()),
        dynamic_paths: None,
