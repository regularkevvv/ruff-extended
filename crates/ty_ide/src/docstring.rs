...
mod tests {
    ...
    #[test]
    fn google_style_parameter_documentation_finds_indented_section() {
...
This line starts at column zero.
    ...
    #[test]
    fn google_style_parameter_documentation_accepts_item_aligned_continuation() {
        let docstring = Docstring::new(
            "\
Args:
    aligned: First line.
    ...
    #[test]
    fn numpy_style_parameter_documentation_overrides_google_style() {
        let docstring = Docstring::new(
            r#"
        Args:
