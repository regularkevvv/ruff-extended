...
Generic call arguments are inferred under fixpoint iteration, allowing constraints to contribute to
type context across arguments within a given generic call, until convergence.
